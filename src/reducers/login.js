 ...
 */
import {ACTIVE_FAIL,ACTIVE_SUCCESS,LOGIN_SUCCESS,LOGIN_FAIL,SIGNOUT_SUCCESS,SIGNOUT_FAIL} from '../actions/login';
...
export default function login(state = initLogin ,action){
    switch (action.type){
        case LOGIN_SUCCESS:
            return Object.assign({},state,{login:true,activeSuccess:true,username:action.username,token:action.token,});
        case LOGIN_FAIL:
